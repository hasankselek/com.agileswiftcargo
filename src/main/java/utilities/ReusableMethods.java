...
public class ReusableMethods {
    ...
    public static void switchToWindowWithTitle(String targetTitle) {
        ...
        Driver.getDriver().switchTo().window(currentWindow); // switch back if title not found
    }
    ...
    public static void uploadFile(String filePath, WebElement uploadElement) {
        ...
        uploadElement.sendKeys(filePath);  // Directly sends the file path to the input element
    }
