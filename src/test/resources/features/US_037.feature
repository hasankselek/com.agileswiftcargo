 ...
 @US_037
 Feature:  As an administrator I would like to access,update, add and
   delete 'Payment' informationen the 'Branch Manage' page.
  ...
  @TC_3701
   Scenario:Branch Payment List' list is visible
    ...
    Scenario: The plus (+) sign in the list to the right of the
             Payment listmust be visible and functional.
